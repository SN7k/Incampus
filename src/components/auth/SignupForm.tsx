...
const SignupForm: React.FC<SignupFormProps> = ({ onBackToLogin, onSignupSuccess }) => {
  ...
  return (
    <div className="bg-white dark:bg-gray-800 p-8 rounded-xl shadow-lg max-w-md w-full">
      ...
      {/* Mock signup info box */}
      <div className="mb-6 p-4 bg-blue-50 dark:bg-blue-900/30 border border-blue-200 dark:border-blue-800 rounded-lg">
        <h3 className="font-medium text-blue-800 dark:text-blue-300 mb-2">Mock Signup Info</h3>
        <div className="text-sm text-gray-700 dark:text-gray-300 space-y-1">
          <p>Fill in any details to create a new mock account</p>
          <p>For student ID format, use: BWU/BCA/20/123</p>
          <p className="italic mt-2">For OTP verification, use code: 123456</p>
        </div>
      </div>
